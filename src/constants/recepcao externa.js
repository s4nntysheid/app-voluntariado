...
const sheetName = "RECEPÇÃO INTERNA";
...
fetch(url)
  ...
  .then((rep) => {
    ...
    jsonData.table.rows.forEach((rowData) => {
      ...
      let voluntB = volunt[7] != null ? volunt[7].v : undefined;
      let voluntD = volunt[8] != null ? volunt[8].v : undefined;
      let voluntCdO = volunt[9] != null ? volunt[9].v : undefined;
      row = {
        id: voluntId,
        nome: voluntName,
